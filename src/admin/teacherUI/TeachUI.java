...
//        		if(fileList.getSelectionModel().getSelectedItem().equals("新建教师")&&count1==0) {
...
//				stage.setTitle("修改密码");
		...
		if(fileList.getSelectionModel().getSelectedItem().equals("新建教师")) {
			System.out.println("新建了一个教师啦~");
...
//        	    List<Student> is =new ArrayList<Student>();
        		...
        		if(dao.add(idnewint, nameBox.getText().toString(), sexcombo.getValue().toString(), yearint, telTextField.getText().toString(), xueyuancombo.getValue().toString(), birthTextField.getText().toString())) {
